<template>
  ...
  <div class="flex upload">
    <div>
      ...
      />
      <p>
        Upload a custom photo or image and configure it via the wallpaper
        configurator.
      </p>
    ...
    <div class="image_info flex" v-show="wall_dimensions.image_url">
      <div class="image_preview">
        <img :src="wall_dimensions.image_url" id="image_preview" alt="" />
      </div>
      <div>
        <small><span>custom image:</span> {{ image_desc.custom_image }}</small>
        <small><span>Price / m²:</span> {{ constants.strip_cost }} €</small>
        <small><span>Image size: </span> {{ image_desc.image_size }}</small>
        <small><span>Resolution: </span> {{ image_desc.custom_image }}</small>
        <small><span>Quality: </span> {{ image_desc.custom_image }}</small>
      </div>
    </div>
    <AddToCartBtn />
  </div>
